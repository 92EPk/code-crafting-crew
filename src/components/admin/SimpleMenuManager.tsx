...
import CategoryTemplates, { CategoryTemplate } from './CategoryTemplates';
...
const SimpleMenuManager = () => {
  ...
  const handleAddQuickItem = (type: 'burger' | 'meat' | 'chicken') => {
    // Find the Main Dishes category since all these items belong there
    const category = categories.find(cat => cat.name_en === 'Main Dishes');
    
    if (!category?.id) {
      toast.error('Main Dishes category must be created first');
      return;
    }

    // Create a base item for the selected type
    const baseItem = {
      category_id: category.id,
      name_ar: type === 'burger' ? 'برجر جديد' : type === 'meat' ? 'طبق لحم جديد' : 'طبق دجاج جديد',
      name_en: type === 'burger' ? 'New Burger' : type === 'meat' ? 'New Meat Dish' : 'New Chicken Dish',
      description_ar: '',
      description_en: '',
      price: 0,
      is_available: true,
  ...
  const handleCopyItem = (item: SimpleMenuItem) => {
    const copiedItem = {
      ...item,
                ...
                <div key={index} className="flex gap-2 items-end">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="meal_base">Meal Base</SelectItem>
                      <SelectItem value="pasta_sauce">Pasta Sauce</SelectItem>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex flex-wrap gap-2">
              <Button 
                variant="outline" 
                size="sm"
                onClick={() => handleAddQuickItem('burger')}
              >
              ...
              <Button 
                variant="outline" 
                size="sm"
                onClick={() => handleAddQuickItem('meat')}
              >
              ...
              <Button 
                variant="outline" 
                size="sm"
                onClick={() => handleAddQuickItem('chicken')}
              >
