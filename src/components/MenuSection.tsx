...
const MenuSection = ({ language, onAddToCart }: MenuSectionProps) => {
  ...
  const handleProductClick = (product: Product) => {
    ...
    if (dbItem?.allow_customization && dbItem.customization_options && dbItem.customization_options.length > 0) {
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                       ...
                       >
                         ...
                         {(dbItem?.allow_customization && dbItem.customization_options?.length > 0) ? t.customize : t.addToCart}
                       </Button>
                    </div>
                  </CardContent>
                </Card>
